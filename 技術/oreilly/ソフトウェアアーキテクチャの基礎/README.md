...
- ユーザ数
  - 数千。いずれは数百万
- 要件
  - ユーザが注文すると、サンドイッチを受け取るれる時間と店舗までの道順を提示  
  (交通情報を含む複数の外部地図サービスとの統合が必要)
  - 店舗が宅配サービスを行っている場合、届先にサンドイッチを宅配
  - モバイル端末でのアクセシビリティ
  - 全国向けにデイリープロモーション用メニューやスペシャルメニューを提供
  - エリア限定でデイリープロモーション用メニューやスペシャルメニューを提供
  - オンラインか直性、または配達時の支払いが可能
- 追加コンテキスト
  - サンドイッチ点はフランチャイズで、オーナーはそれぞれ異なる
  - 親会社は近日中に海外展開を予定
  - 安い労働力を雇って利益を最大化するのがゴール

#### 5.3.1 明示的な特性

- ユーザ数：現在は数千だが、将来的には数百万 → スケーラビリティ
- 
